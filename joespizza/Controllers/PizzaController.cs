...
namespace joespizza.Controllers
{
    public class PizzaController : Controller
    {
        ...
        {
            p.Add(new PizzaModel() { ID = 1, PizzaName = "Veg Pizza", Price = 120});
            p.Add(new PizzaModel() { ID = 2, PizzaName = "Chicken Pizza", Price = 250 });
            p.Add(new PizzaModel() { ID = 3, PizzaName = "Cheese Pizza", Price = 190 });
            p.Add(new PizzaModel() { ID = 4, PizzaName = "Chicken Cheese Pizza", Price = 300 });
            p.Add(new PizzaModel() { ID = 5, PizzaName = "Manchuriya Pizza", Price = 300 });
        }
